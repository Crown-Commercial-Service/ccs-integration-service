...
{ 
    ...
    { 
        ...
        /// <summary>
        /// Invitation to Tender Sourcing Event Status
        /// </summary>
        /// <value>Invitation to Tender Sourcing Event Status</value>
        [DataMember(Name="status")]
        public int? Status { get; set; }

        /// <summary>
        /// Gets or Sets IttOwner
        /// </summary>
        [DataMember(Name="ittOwner")]
        public User IttOwner { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IttOwner: ").Append(IttOwner).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Tender)obj);
        }
        ...
        public bool Equals(Tender other)
        {
            ...
            return 
                ...
                (
                    IttOwner == other.IttOwner ||
                    IttOwner != null &&
                    IttOwner.Equals(other.IttOwner)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (IttOwner != null)
                    hashCode = hashCode * 59 + IttOwner.GetHashCode();
                return hashCode;
            }
        }
